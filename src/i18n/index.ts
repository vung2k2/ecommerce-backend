...
const errorMessageKeys = {
  ...
  [ERROR_CODES.VARIANT_INACTIVE]: 'errors.variantInactive',
  ...
  [ERROR_CODES.CART_NOT_FOUND]: 'errors.cartNotFound',
  [ERROR_CODES.CART_ITEM_NOT_FOUND]: 'errors.cartItemNotFound',
  [ERROR_CODES.CART_ITEM_QUANTITY_INVALID]: 'errors.cartItemQuantityInvalid',
  [ERROR_CODES.CART_NO_AVAILABLE_ITEMS]: 'errors.cartNoAvailableItems',
  [ERROR_CODES.COUPON_NOT_FOUND]: 'errors.couponNotFound',
  [ERROR_CODES.COUPON_CODE_EXISTS]: 'errors.couponCodeExists',
  [ERROR_CODES.COUPON_INACTIVE]: 'errors.couponInactive',
  [ERROR_CODES.COUPON_NOT_STARTED]: 'errors.couponNotStarted',
  [ERROR_CODES.COUPON_EXPIRED]: 'errors.couponExpired',
  [ERROR_CODES.COUPON_MIN_ORDER_NOT_MET]: 'errors.couponMinOrderNotMet',
  [ERROR_CODES.COUPON_USAGE_LIMIT_EXCEEDED]: 'errors.couponUsageLimitExceeded',
  [ERROR_CODES.COUPON_USER_LIMIT_EXCEEDED]: 'errors.couponUserLimitExceeded',
